...
Trabajaremos con datos reales de la **Encuesta CASEN 2024**. Para facilitar el trabajo durante el práctico, utilizaremos una submuestra aleatoria reproducible de **1.000 personas ocupadas con información válida en las tres variables analizadas**. Esa misma submuestra se utilizará durante todo el práctico.
...
::: {.callout-important title="Desviación no es desviación estándar"}
