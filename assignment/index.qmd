...
- Los prácticos consisten en el desarrollo de una guía práctica (por lo general cada semana) donde se aplican y profundizan los contenidos de las clases, y donde también se abordan otras temáticas relacionadas al manejo y reporte de datos. La organización semestras se puede revisar en la [planificación del curso](/schedule.html).
