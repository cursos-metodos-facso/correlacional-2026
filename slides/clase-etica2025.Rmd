...
output:
  xaringan::moon_reader:
    css: ["clase-etica2025/custom_lisa.css","https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css"] # "../ninjutsu.css", paraflipbook
    includes:
