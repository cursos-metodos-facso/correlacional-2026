...
[Test de hipótesis]{style="color: #dfc117;"}
...
::: {.fragment}
### [¿Cuándo una hipótesis es [verdadera]{style="color: #dfc117;"}?]{style="color: white;"}
:::
...
- [(Una nota preliminar)]{style="color: #ffe08a;"} En general, existen 2 formas de realizar el contraste de hipótesis:
...
## 2. Error estándar (y estadístico de prueba) {style="font-size: 0.75em;"}
...
## Hipótesis nula ( $H_0$) y tipos de error {style="font-size: 0.8em;"}
...
## Nivel de confianza y probabilidad de error $\alpha$ {style="font-size: 0.8em;"}
...
## Test de hipótesis de diferencias en R {style="font-size: 0.75em;"}
...
## tabla t test con `rempsyc` {style="font-size: 0.75em;"}
...
## Próxima clase (miércoles): manos al código {style="font-size: 0.85em;"}

::: {style="border-top: 1px solid #0C3547; margin: 0.3em 0;"}
:::
