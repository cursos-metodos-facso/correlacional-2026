...
En esta sección se encuentran disponibles los documentos de presentación que sirven de base a cada clase, en el menú de la izquierda _Presentaciones_. Los documentos son en formato html (no son ppt), producidos con [Quarto](https://quarto.org/). Para verlos en pantalla completa presionar _F_ sobre el documento, y para una vista general de todas las slides presionar _O_.
