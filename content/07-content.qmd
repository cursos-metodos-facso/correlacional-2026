...
<div id="pasos1-box" class="unlock-box">
  ...
  <label for="pasos1-input">
    <strong>🔒 Solución bloqueada.</strong><br>
    Ingresa la clave para ver los 5 pasos de la inferencia.
  </label>

  <p style="margin-top: 10px;">
    💡 <strong>Clave:</strong> <code>promedio</code>
  </p>

  <input type="password" id="pasos1-input" placeholder="Ingresa la clave">

  <button onclick="unlockSection('pasos1','promedio')">
    Ver solución
  </button>

  <div id="pasos1-msg" class="unlock-msg">
...
<div id="pasos2-box" class="unlock-box">
  ...
  <label for="pasos2-input">
    <strong>🔒 Solución bloqueada.</strong><br>
    Ingresa la clave para ver los 5 pasos de la inferencia.
  </label>

  <p style="margin-top: 10px;">
    💡 <strong>Clave:</strong> <code>diferencia-medias</code>
  </p>

  <input type="password" id="pasos2-input" placeholder="Ingresa la clave">

  <button onclick="unlockSection('pasos2','diferencia-medias')">
    Ver solución
  </button>

  <div id="pasos2-msg" class="unlock-msg">
    Clave incorrecta, inténtalo de nuevo.
  </div>
...
<div id="pasos3-box" class="unlock-box">
  ...
  <label for="pasos3-input">
    <strong>🔒 Solución bloqueada.</strong><br>
    Ingresa la clave para ver los 5 pasos de la inferencia.
  </label>

  <p style="margin-top: 10px;">
    💡 <strong>Clave:</strong> <code>proporciones</code>
  </p>

  <input type="password" id="pasos3-input" placeholder="Ingresa la clave">

  <button onclick="unlockSection('pasos3','proporciones')">
    Ver solución
  </button>

  <div id="pasos3-msg" class="unlock-msg">
    Clave incorrecta, inténtalo de nuevo.
  </div>
